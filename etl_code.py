...
#* 1- Create a folder data_source and use the terminal shell to change the current directory to 
#*    \home\project\data_source. Create a file etl_practice.py in this folder.

#* 2- Download and unzip the data available in the link shared above.

#* 3- The data available has four headers: 'car_model', 'year_of_manufacture', 'price', 'fuel'. Implement the extraction 
#*    process for the CSV, JSON, and XML files.
